...
namespace Ophelia.Web.View.Mvc.Controls.Binders.CollectionBinder
{
    public static class Extensions
    {
        ...
        public static Columns.NumericColumn<TModel, T> AddEditableNumericColumn<TModel, T>(this CollectionBinder<TModel, T> binder, Expression<Func<T, object>> expression, Expression<Func<T, object>> identifierExpression, string identifierKeyword = "", string Text = "", object htmlAttributes = null) where T : class where TModel : ListModel<T>
        {
