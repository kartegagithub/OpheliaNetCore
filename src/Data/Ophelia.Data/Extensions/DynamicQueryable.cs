...
namespace Ophelia
{
    ...
    where TElement : class
        ...
        private static Type GetQueryableType(this IQueryable source)
        {
            ...
            {
                return (Type)source.ExecuteMethod("GetOpheliaType");
            }
        ...
        public static IQueryable Select(this IQueryable source, string selector, params object[] values)
        {
            ...
            return source.Provider.CreateQuery(
                Expression.Call(
                    source.GetQueryableType(), "Select",
        ...
        public static IQueryable OrderBy(this IQueryable source, string ordering, params object[] values)
        {
            ...
            foreach (DynamicOrdering o in orderings)
            {
                queryExpr = Expression.Call(
                    source.GetQueryableType(), o.Ascending ? methodAsc : methodDesc,
        ...
        public static IQueryable GroupBy(this IQueryable source, string keySelector, string elementSelector, params object[] values)
        {
            ...
            return source.Provider.CreateQuery(
                Expression.Call(
                    source.GetQueryableType(), "GroupBy",
    ...
    internal class ExpressionParser
    {
        ...
        static readonly Type[] predefinedTypes = {
            ...
            typeof(Math),
            typeof(Convert),
            typeof(Microsoft.EntityFrameworkCore.DbFunctionsExtensions)
        };
...
#pragma warning restore 0219
        ...
        static Dictionary<string, object> CreateKeywords()
        {
            ...
            var additionalType = Type.GetType("Microsoft.EntityFrameworkCore.SqlServerDbFunctionsExtensions");
            if (additionalType != null)
                d.Add(additionalType.Name, additionalType);

            additionalType = Type.GetType("Microsoft.EntityFrameworkCore.NpgsqlDbFunctionsExtensions");
            if (additionalType != null)
                d.Add(additionalType.Name, additionalType);

            //TODO: Oracle, MySQL funstions will be added here.
